...
| C2.1.2 Intégration continue | PR et `main` : audit, lint, types, couverture, build, axe, audits structurels, Rust, WASM et Clippy | workflow `_checks.yml`, `deployment-runs-2026-07-21.md`, artefacts | ACQUIS : PR #4 et `main` verts sur la révision courante `07fb59a` |
