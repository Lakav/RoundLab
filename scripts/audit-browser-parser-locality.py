...
def assert_worker_returns_id_only() -> None:
    ...
    required = {
        ...
        "browser backend parse return type": (backend, "async parseDemo(source: DemoSource): Promise<string>"),
        ...
        "backend parser contract returns id": (backend_types, "parseDemo(source: DemoSource): Promise<string>"),
