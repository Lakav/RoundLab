...
export const STAT_DEFINITIONS: Record<string, string> = {
  ...
  "Kills HS %": "Part des kills réalisés avec un headshot.",
  "Head accuracy": "Part des impacts associés qui touchent la tête, en excluant l’AWP.",
  "Précision tête": "Part des impacts associés qui touchent la tête, en excluant l’AWP.",
  ...
  "Précision spray": "Part des tirs de sprays de fusil qui touchent quand un ennemi est repéré.",
  ...
  Clutchs: "Situations où un joueur reste seul face à un ou plusieurs adversaires.",
  ...
  Accuracy: "Part de tous les tirs qui sont associés à au moins un dégât.",
  "Accuracy (enemy spotted)": "Part des tirs qui touchent lorsque la démo indique qu’un ennemi est repéré.",
  "Headshot accuracy": "Part des impacts associés qui touchent la tête, en excluant l’AWP.",
  "Counter-strafing": "Part des tirs évaluables précédés d’un arrêt rapide compatible avec un counter-strafe.",
  "Counter-strafing (avg)": "Part moyenne des tirs évaluables précédés d’un arrêt rapide.",
  "Crosshair placement": "Écart angulaire entre le viseur et la cible au moment de sa première visibilité.",
  "Shots (enemy spotted)": "Nombre de tirs effectués pendant qu’au moins un adversaire vivant est repéré.",
  "Scoped shots": "Tirs dont la dernière frame strictement antérieure, au maximum 250 ms avant le tir, indique que la lunette est active.",
  "Shots while moving": "Part des tirs évalués où le joueur se déplace encore au moment du tir.",
  "HS%": "Part des kills réalisés avec un headshot.",
  "Damage per hit": "Dégâts de santé moyens par événement d’impact associé.",
  "Shots hit": "Tirs associés à au moins un événement de dégâts.",
  Hits: "Tirs associés à au moins un événement de dégâts.",
  "Trade kill attempts": "Réponses où le joueur inflige des dégâts à l’adversaire après la mort d’un coéquipier, dans la fenêtre de trade.",
  "Trade kill opportunities": "Nombre de situations de clutch détectées.",
  "Trade kill success": "Trade kills divisés par les tentatives de trade mesurables.",
  "Traded deaths": "Morts suivies rapidement par l’élimination de l’adversaire responsable.",
  "Traded deaths %": "Part des morts du match suivies d’un trade kill allié.",
  "Opening attempts": "Nombre d’openings gagnés ou perdus par le joueur. Le pourcentage indique la part de ses rounds concernés.",
  "Opening success": "Openings gagnés divisés par les tentatives d’opening.",
  Saves: "Clutchs perdus où le joueur survit et conserve son équipement pour le round suivant. Déduit du vainqueur du round et de la survie, la démo ne fournissant pas de motif de fin de round.",
  "Post-plant": "Clutchs commencés alors que la bombe était déjà posée.",
  "Flash blind duration": "Durée moyenne pendant laquelle les adversaires restent aveuglés par une flash.",
  "Unused utility on death": "Valeur moyenne des utilitaires encore détenus au moment de la mort.",
  "Enemies flashed per flash": "Nombre moyen d’adversaires effectivement aveuglés par flash lancée.",
  "Teammates flashed per flash": "Nombre moyen de coéquipiers effectivement aveuglés par flash lancée.",
  "Flashbangs leading to kills": "Nombre moyen de kills alliés réalisés pendant l’aveuglement provoqué par une flash.",
  "HE damage per grenade": "Dégâts moyens infligés par grenade HE lancée.",
  "Teammate HE damage per grenade": "Dégâts moyens infligés aux coéquipiers par grenade HE lancée.",
  Survival: "Rounds terminés en vie. Le pourcentage est calculé sur les rounds effectivement joués.",
  "Net spend": "Somme des achats moins remboursements. RoundLab la laisse indisponible tant que la sémantique temporelle du flux d’achats n’est pas validée.",
  "Equipment value lost on death": "Somme de current_equip_value sur la dernière frame strictement antérieure à chaque mort.",
  "Avg value lost": "Valeur d’équipement moyenne observée juste avant chaque mort exploitable.",
  "Saved weapons": "Rounds perdus terminés en vie avec un fusil, sniper, PM, pompe ou mitrailleuse dans l’inventaire.",
  "Anti-eco rounds": "Rounds où l’équipement moyen adverse est classé eco à la fin du freeze time.",
  "Anti-eco conversion": "Part des rounds gagnés parmi les rounds où l’adversaire est classé eco.",
  "Losses vs eco": "Rounds perdus alors que l’équipement moyen adverse est classé eco.",
  "Man-advantage rounds": "Rounds où l’équipe possède au moins une fois plus de joueurs vivants que l’adversaire après une mort ou déconnexion.",
  "Advantage conversion": "Part des rounds gagnés parmi ceux où l’équipe obtient un avantage numérique.",
  "Teammate distance": "Distance horizontale moyenne entre le joueur et ses coéquipiers.",
  Shots: "Nombre de tirs enregistrés dans la démo.",
  "Enemies flashed": "Adversaires effectivement aveuglés par les flashes du joueur.",
  "Utility thrown": "Nombre total de grenades lancées.",
  "Unused utility": "Valeur des utilitaires encore détenus à la mort.",
  "HE damage": "Dégâts infligés aux adversaires par les grenades HE.",
  "Crouched shots": "Part des tirs effectués accroupi.",
  "First bullet accuracy": "Part des premières balles de chaque séquence qui touchent.",
  "Clutch outcomes": "Issue de chaque clutch : gagné, perdu ou sauvé.",
  Damage: "Dégâts de santé infligés aux adversaires.",
      ...
      <TooltipTrigger
        render={(
          <span
            tabIndex={0}
            className={[
              "cursor-help font-semibold outline-none transition-colors hover:text-[var(--rl-positive)] focus-visible:text-[var(--rl-positive)]",
              className,
            ].join(" ")}
          />
        )}
