...
4. Decide how strict weapon-fire parity really needs to be. The remaining missing Rust cases appear to come from demoparser-rust event extraction, and tick-row `FIRE` is too noisy to use directly.
