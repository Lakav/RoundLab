...
| REC-09 | Node/pnpm attendus | build normal et `/RoundLab` | construire l'export | routes statiques, assets résolus | builds local, PR #4, `main` et Pages de la candidate applicative verts | OK | 2026-07-21 | build + audit output + runs 29835730211/29835960094/29836168860 |
| REC-10 | périmètre Vitest global | code frontend incluant `MapRenderer` | exécuter la couverture | ≥ 60/50/60/60 et CI bloquante | 61,68/52,32/72,51/63,70 ; `MapRenderer` 52,72 % statements | OK | 2026-07-21 | HTML, JSON, LCOV, log couverture ; RL-2026-005 |
...
| REC-15 | Chrome sur macOS, clavier, zoom navigateur, outils de contraste et arbre d'accessibilité | accueil, import, progression, bibliothèque, replay, dialogues | vérifier clavier, focus, zooms 200/400 %, défilement, contrastes canvas, cohérence canvas/DOM, noms, rôles et états | neuf contrôles démontrés et grille documentée ; limite lecteur d'écran conservée | cinq contrôles conformes, quatre contrôles réels encore non démontrés | BLOQUÉ | 2026-07-21 | `accessibilite-controles-manuels.csv`, `rgaa-4.1.2-grille.csv`, `05-accessibilite-rgaa.md` |
| REC-16 | candidate v0.1.40 fusionnée avec CI verte | workflow Pages et SHA applicatif candidat | déployer, smoke, rollback, restaurer | révision candidate restaurable | CI PR et `main` vertes ; déploiement `07fb59a`, smoke public, rollback `2e51eaf`, changement de chunk observé, restauration `07fb59a` et smoke réussis | OK | 2026-07-21 | `deployment-runs-2026-07-21.md` |
...
REC-14 est validé par les dix fixtures réelles. REC-15 ne dépend pas d'un lecteur d'écran ; il ne doit changer de statut qu'après démonstration des neuf contrôles structurés et renseignement honnête des 106 critères. Les deux sessions utilisateurs réelles sont un gate séparé. Le tag v0.1.40 reste interdit tant qu'un de ces contrôles est bloqué.
