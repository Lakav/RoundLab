...
use crate::second_pass::collect_data::{C4Record, ProjectileRecord};
...
impl<'a> Parser<'a> {
    ...
    fn combine_outputs(&self, second_pass_outputs: &mut Vec<SecondPassOutput>, first_pass_output: FirstPassOutput) -> DemoOutput {
        ...
        DemoOutput {
            ...
            c4_records: second_pass_outputs.iter().flat_map(|x| x.c4_records.clone()).collect(),
