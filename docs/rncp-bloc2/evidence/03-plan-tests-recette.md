...
| REC-09 | Node/pnpm attendus | build normal et `/RoundLab` | construire l'export | routes statiques, assets résolus | builds local, PR #4, `main` et Pages de la candidate courante verts | OK | 2026-07-21 | build + audit output + runs 29835730211/29835960094/29836168860 |
