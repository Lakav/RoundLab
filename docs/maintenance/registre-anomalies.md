...
| --- | --- | --- | --- | --- | --- |
| INC-001 | 22/07/2026 | croissance mémoire pendant les longs replays | P1 | corrigée | `19a13c8` |
| INC-002 | 22/07/2026 | échec d'import d'une très grande démo | P1 | corrigée | `c995760` |
| INC-003 | 30/07/2026 | dépendances web vulnérables | indéterminée | corrigée selon le commit | `815fd82` |
| INC-004 | 03/08/2026 | deux dépendances Rust affectées par des avis d'unsoundness | P2 | corrigée | `Cargo.lock` |
| INC-005 | 17/08/2026 | 16 avis npm, dont 6 élevés | P1 | corrigée | `pnpm-workspace.yaml`, `pnpm-lock.yaml` |

La sévérité de INC-001 et INC-002 est une estimation rétrospective à partir de
l'impact visible. Elle n'était pas enregistrée lors du traitement. La sévérité
de INC-003 est impossible à déterminer sans l'avis de sécurité
d'origine.

## INC-005 - Avis npm détectés le 17 août 2026
...
## INC-002 - Échec d'import d'une très grande démo
...
## INC-003 - Dépendances web vulnérables
...
## INC-004 - Avis RustSec sur `anyhow` et `memmap2`
